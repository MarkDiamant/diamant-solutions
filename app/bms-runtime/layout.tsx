...
export default function BmsRuntimeLayout({children}:{children:React.ReactNode}){return <><BmsRuntimeGuard/><div className="bg-[#17385f] px-4 py-2 text-center text-xs font-black text-white print:hidden">DEMO MODE · Fictional data · External actions are disabled · Changes reset automatically</div><AdminBrandBar/><AdminPrimaryNav/>{children}<footer className="border-t border-black/10 bg-white px-4 py-2 text-center text-black/40 print:hidden"><DiamantCredit/></footer></>;}
