...
export const metadata:Metadata={title:"Business Management Software | Diamant Solutions",robots:{index:false,follow:false,nocache:true},manifest:"/api/business-software/manifest",icons:{icon:"/favicon.ico",shortcut:"/favicon.ico",apple:"/favicon.ico"}};
