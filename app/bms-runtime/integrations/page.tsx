...
export default function IntegrationsPage() {
  ...
  async function load() {
    setLoading(true);
    const response = await fetch("/api/admin/integrations/xero/status", { cache: "no-store" });
