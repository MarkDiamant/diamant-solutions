...
const support=[
  ...
  ['03','Pricing and profitability','Review pricing, margins and commercial decisions with a practical focus on stronger profitability.'],
  ['04','Business systems and processes','Improve how work moves through the business so fewer things rely on memory, chasing or firefighting.'],
  ['05','Client journeys and operational improvements','Identify friction in the customer experience and tighten the operational steps behind it.'],
  ['06','Accountability and implementation','Agree clear next actions, follow through on them and keep important work moving.'],
  ['07','Digital, website and automation opportunities','Spot sensible opportunities to use websites, systems or automation where they can genuinely save time or improve results.']
];
  ...
  return <main className="advisoryPage">
    ...
    <section className="advisoryHero">
      <div className="advisoryHeroCopy revealAdvisory fromLeft">
        ...
        <div className="advisoryActions"><a className="advisoryPrimary" href="#book">Book a Session <span>→</span></a><a className="advisorySecondary" href="#support">See how I can help</a></div>
      </div>
    ...
    <section id="support" className="advisorySection">
      ...
      <div className="supportGrid">{support.map((item,i)=><article key={item[0]} className={'supportCard revealAdvisory '+(i%2?'fromRight':'fromLeft')}><b>{item[0]}</b><h3>{item[1]}</h3><p>{item[2]}</p></article>)}</div>
    </section>
    ...
    <section className="tailored">
      <div className="tailoredInner">
        ...
        <div className="tailoredCopy revealAdvisory fromRight"><p>Every business is different. The session is shaped around what is creating pressure, slowing progress or needs a decision now.</p><p>The aim is simple: understand the issue, make the decision, agree the next action and make sure it actually gets implemented.</p><div className="actionSteps"><div className="actionStep"><b>01</b><span>Understand</span></div><div className="actionStep"><b>02</b><span>Decide</span></div><div className="actionStep"><b>03</b><span>Act</span></div><div className="actionStep"><b>04</b><span>Follow through</span></div></div></div>
      </div>
    </section>

    <section className="aboutYehuda">
      <div className="revealAdvisory fromLeft" style={{position:'relative'}}><div className="yehudaAccent"/><div className="yehudaFrame"><img src="/yehuda-diamant.jpg" alt="Yehuda Diamant" onError={e=>e.currentTarget.classList.add('isMissing')}/></div></div>
      <div className="aboutYehudaCopy revealAdvisory fromRight"><p className="advisoryKicker">ABOUT YEHUDA</p><h2>Practical experience, not just theory.</h2><p>Yehuda Diamant is an entrepreneur and director of multiple businesses, with hands-on experience launching, running and developing businesses and digital projects. He is also actively involved in community organisations and previously spent seven years providing business coaching through Mesila, including delivering business talks and webinars.</p><p>His approach is practical: understand the issue, make a decision, agree the next action and make sure it actually gets implemented.</p><div className="aboutFacts"><div className="aboutFact">Entrepreneur and business director</div><div className="aboutFact">Hands-on digital project experience</div><div className="aboutFact">7 years coaching through Mesila</div><div className="aboutFact">Business talks and webinars</div></div></div>
    </section>
