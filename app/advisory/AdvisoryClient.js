...
export default function AdvisoryClient(){
  ...
  return <main className="advisoryPage">
    ...
    <section className="aboutYehuda">
      <div className="revealAdvisory fromLeft" style={{position:'relative'}}><div className="yehudaAccent"/><div className="yehudaFrame"><img src="/yehuda-diamant.jpg" alt="Mark Diamant" onError={e=>e.currentTarget.classList.add('isMissing')}/></div></div>
