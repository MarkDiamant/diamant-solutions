...
export async function GET(request,{params}){
  ...
  const r=await centralRest(`business_software_integrations?tenant_id=eq.${encodeURIComponent(tenant.id)}&select=provider,status,scopes,connected_at,token_expires_at,updated_at`);
