...
export async function GET(request){
 try{
  ...
  const expectedTenant = staging && tx.tenant_id === "3ebc2265-8842-4826-b464-71783d6cf841" ? "63f524e9-78fd-4864-b273-9f504b0a6503" : null;
  const org = expectedTenant ? connections.find(c => c.tenantId === expectedTenant) : connections.length === 1 ? connections[0] : null;
  if (!org) return NextResponse.redirect(destination(tx.return_origin, "choose_org"));
