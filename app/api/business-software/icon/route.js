...
export async function GET(request){
 ...
 let src=h==="mjmetal.diamantsolutions.co.uk"?"https://mjmetal.co.uk/images/logo.png":(settings?.app_icon_url||settings?.appIconUrl||settings?.logo_url||settings?.logoUrl||null);
