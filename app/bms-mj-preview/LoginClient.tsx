...
export default function LoginClient({tenantName}:{tenantName:string}){
 ...
 return <main style={{minHeight:"100vh",background:"#f5f5f2",display:"grid",placeItems:"center",padding:"24px",fontFamily:"Arial,Helvetica,sans-serif",color:"#172b4d"}}>
  <div style={{width:"100%",maxWidth:430,background:"#fff",border:"1px solid #00000018",borderRadius:24,padding:"32px",boxShadow:"0 14px 50px rgba(0,0,0,.08)"}}>
   <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:18,marginBottom:18}}><img src="/api/business-software/icon" alt={tenantName+" logo"} style={{height:52,width:"auto",maxWidth:170,objectFit:"contain"}}/><span style={{fontSize:11,fontWeight:800,color:"#98a2b3"}}>Business Management Software</span></div>
   <h1 style={{fontSize:34,lineHeight:1.1,margin:"10px 0 8px",fontWeight:900}}>Welcome {tenantName}</h1>
