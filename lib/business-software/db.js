const SB=process.env.NEXT_PUBLIC_SUPABASE_URL||"https://iepqggrfenfqrqyzqyed.supabase.co";
const SK=process.env.SUPABASE_SERVICE_ROLE_KEY;
const PK=process.env.NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY||"sb_publishable_ivTCLFGFroexc-3IHe25bg_qhzg_GIy";
